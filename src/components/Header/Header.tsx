...
import { Button, Container, Dropdown, FavoriteButton, Icon, Image } from '@app/common/components';
    ...
    return (
      <>
        ...
        <StyledLink href="/favorites">
          <Icon kind="heart" className="w-8 h-8 p-1 transition-opacity hover:opacity-8-" />
